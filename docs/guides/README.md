...
- [Base URL](../guides/assets.md#base-url)
- [Deploy Guide > Github Pages](../guides/deploy.md#github-pages)
...
Specify locales for i18n support. For more details, see the guide on [Internationalization](../guides/i18n.md).
...
- [Line Numbers](../guides/markdown.md#line-numbers)
